...
<div class="bg-light p-4 rounded row">
    ...
    @endif
    @if(count($coursesDeptSemester) !=0 )
        <h2>index courses for spesific Department/Semester</h2>
        <div class="lead">
            index for spesific Department/Semester.
        </div>
            @foreach ($coursesDeptSemester as $course)
