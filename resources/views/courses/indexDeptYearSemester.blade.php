...
<div class="bg-light p-4 rounded row">
    ...
    @endif
    @if(count($coursesDeptYearSemester) !=0 )
        <h2>index courses for spesific Department/Year/Semester</h2>
        <div class="lead">
            index for spesific Department/Year/Semester.
        </div>
            @foreach ($coursesDeptYearSemester as $course)
            <div class="card mb-3 mx-1 border-warning">
                    <div class="row g-0">
                        <div class="col-md-7">
